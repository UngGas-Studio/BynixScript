...
function executeCode(code) {
  if (code.match(/let\s+([a-zA-Z_][a-zA-Z0-9_]*)/g) || code.match(/function\s+([a-zA-Z_][a-zA-Z0-9_]*)\s*\(([^)]*)\)/g) || code.match(/if\s\((.+?)\)\s{/g) || code.match(/else if\s\((.+?)\)\s{/g) || code.match(/else\s\((.+?)\)\s{/g) || code.match(/console.log\((.+?)\)/g) || code.match(/alert\((.+?)\)/g) || code.match(/prompt\((.+?)\)/g) || code.match(/Math\.random\((.+?)\)/g) || code.match(/Math\.floor\((.+?)\)/g) || code.match(/Math\.ceil\((.+?)\)/g) || code.match(/Math\.min\((.+?)\)/g) || code.match(/Math\.max\((.+?)\)/g) || code.match(/document\.createElement\((.+?)\)/g) || code.match(/document\.(.+?)\.appendChild\((.+?)\)/g) || code.match(/(.+?).replace\((.+?)\)/g) || code.match(/\/\//g) || code.match(/(.+?)\.textContent\s=\s(.+?)/g) || code.match(/\/\*(.+?)\*\//g) || code.match(/document\.addEventListener\((.+?), function\(\) \{/g) || code.match(/forEach\((.+?) \=\> \{/g) || code.match(/(.+?)\.includes\((.+?)\)/g) || code.match(/(.+?)\.match\((.+?)\)/g) || code.match(/(.+?)\.value ===/g) || code.match(/(.+?)\.value ==/g) || code.match(/(.+?)\.value =/g) || code.match(/(.+?)\.value !===/g) || code.match(/(.+?)\.value !==/g) || code.match(/(.+?)\.value !=/g) || code.match(/(.+?)\.value >/g) || code.match(/(.+?)\.value </g) || code.match(/(.+?)\.value \=\>/g) || code.match(/(.+?)\.value <==/g) || code.match(/(.+?)\.style ===/g) || code.match(/(.+?)\.style ==/g) || code.match(/(.+?)\.style =/g) || code.match(/(.+?)\.style !===/g) || code.match(/(.+?)\.style !==/g) || code.match(/(.+?)\.style !=/g) || code.match(/(.+?)\.style >/g) || code.match(/(.+?)\.style </g) || code.match(/(.+?)\.style \=\>/g) || code.match(/(.+?)\.style <==/g) || code.match(/(.+?)\.style\.(.+?) =/g) || code.match(/(.+?)\.style =/g) || code.match(/(.+?)\.checked/g) || code.match(/(.+?)\.required/g) || code.match(/setTimeout\(function\(\) \{/g) || code.match(/setInterval\(function\(\) \{/g) || code.match(/for \((.+?)\) \{/g) || code.match(/classList\.add\((.+?)\)/) || code.match(/switch\s\((.+?)\)/g) || code.match(/break\:/g) || code.match(/default\:/g) || code.match(/image\((.+?), (.+?)\)/g)) {
