...
function executeCode(code) {
  if (code.match(/let\s/g) || code.match(/function\s/g) || code.match(/if\s\((.+?)\)\s{/g) || code.match(/else if\s\((.+?)\)\s{/g) || code.match(/else\s{\s/g) || code.match(/console(.+?)\((.+?)\)/g) || code.match(/alert\((.+?)\)/g) || code.match(/prompt\((.+?)\)/g) || code.match(/Math\.random\((.+?)\)/g) || code.match(/Math\.floor\((.+?)\)/g) || code.match(/Math\.ceil\((.+?)\)/g) || code.match(/Math\.min\((.+?)\)/g) || code.match(/Math\.max\((.+?)\)/g) || code.match(/document\.createElement\((.+?)\)/g) || code.match(/document\.(.+?)\.appendChild\((.+?)\)/g) || code.match(/(.+?).replace\((.+?)\)/g) || code.match(/\/\//g) || code.match(/(.+?)\.textContent\s=\s(.+?)/g) || code.match(/\/\*(.+?)\*\//g) || code.match(/document\.addEventListener\((.+?), function\(\) \{/g) || code.match(/forEach\((.+?) \=\> \{/g) || code.match(/(.+?)\.includes\((.+?)\)/g) || code.match(/(.+?)\.match\((.+?)\)/g) || code.match(/(.+?)\.value ===/g) || code.match(/(.+?)\.value ==/g) || code.match(/(.+?)\.value =/g) || code.match(/(.+?)\.value !===/g) || code.match(/(.+?)\.value !==/g) || code.match(/(.+?)\.value !=/g) || code.match(/(.+?)\.value >/g) || code.match(/(.+?)\.value </g) || code.match(/(.+?)\.value \=\>/g) || code.match(/(.+?)\.value <==/g) || code.match(/(.+?)\.style ===/g) || code.match(/(.+?)\.style ==/g) || code.match(/(.+?)\.style =/g) || code.match(/(.+?)\.style !===/g) || code.match(/(.+?)\.style !==/g) || code.match(/(.+?)\.style !=/g) || code.match(/(.+?)\.style >/g) || code.match(/(.+?)\.style </g) || code.match(/(.+?)\.style \=\>/g) || code.match(/(.+?)\.style <==/g) || code.match(/(.+?)\.style\.(.+?) =/g) || code.match(/(.+?)\.style =/g) || code.match(/(.+?)\.checked/g) || code.match(/(.+?)\.required/g) || code.match(/setTimeout\(function\(\) \{/g) || code.match(/setInterval\(function\(\) \{/g) || code.match(/for \((.+?)\) \{/g) || code.match(/classList\.add\((.+?)\)/g) || code.match(/switch\s\((.+?)\)/g) || code.match(/break\:/g) || code.match(/default\:/g) || code.match(/image\((.+?), (.+?)\)/g) || code.match(/class\s(.+?)\s\{/g) || code.match(/class\s(.+?)\sextends\s(.+?)\s\{/g) || code.match(/constructor(.+?)\s\{/g) || code.match(/(.+?)\((.+?)\)\s\{/g) || code.match(/static(.+?)\s\{/g) || code.match(/typeof\s(.+?)\s(.+?)\s(.+?)/g) || code.match(/\.map\(function\((.+?)\)\s\{/g) || code.match(/\.filter\(function\((.+?)\)\s\{/g) || code.match(/\.reduce\(function\((.+?)\)\s\{/g)) {
  ...
  code = code.replace(/isType\((.+?)\)/g, (match, p1) => `typeof ${p1}`)
  code = code.replace(/isStr\((.+?)\)/g, (match, p1) => `typeof ${p1} === "string"`)
  code = code.replace(/isNum\((.+?)\)/g, (match, p1) => `typeof ${p1} === "number"`)
  code = code.replace(/isBool\((.+?)\)/g, (match, p1) => `typeof ${p1} === "boolean"`)
  code = code.replace(/isUndef\((.+?)\)/g, (match, p1) => `typeof ${p1} === "undefined"`)
  code = code.replace(/isObj\((.+?)\)/g, (match, p1) => `typeof ${p1} === "object"`)
  code = code.replace(/isFunc\((.+?)\)/g, (match, p1) => `typeof ${p1} === "function"`)
  code = code.replace(/isSym\((.+?)\)/g, (match, p1) => `typeof ${p1} === "symbol"`)
  code = code.replace(/isBig\((.+?)\)/g, (match, p1) => `typeof ${p1} === "bigint"`)
